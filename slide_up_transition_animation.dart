        ...
        children: [
          ...
          PageView.builder(
            ...
            itemBuilder: (context, index) {
              return PageViewItem(currentPage: _currentPage, index: index);
            },
          ),
        ],
      ),
...
class PageViewItem extends StatelessWidget {
  const PageViewItem({
    ...
    required int index,
  }) : _currentPage = currentPage, _index = index;
        ...
        child: ClipRRect(
          ...
          child: ColoredBox(
            ...
            child: AnimatedContainer(
              ...
              height: _currentPage == _index ? 590 : 390,
              child: Wrap(
                ...
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      ...
                      height: _currentPage == _index ? 500 : 350,
                    ),
                  ),
                  Row(
